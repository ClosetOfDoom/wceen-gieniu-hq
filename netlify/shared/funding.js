// Funding radar data for gieniu-command.js.
//
// This was netlify/functions/_funding.json, loaded with require(). gieniu-command.js
// is now a real ES module (so it can import the shared Supabase reader), and a
// JSON import in ESM depends on import attributes and on which bundler Netlify
// picks. A plain JS module has neither question mark, so the data lives here
// instead. The old JSON file is deleted — this is a move, not a copy.
export const FUNDING_RADAR = {
  "PATHS": {
    "cogni": "Cogni / IT",
    "edukacja": "Edukacja",
    "ekologia": "Ekologia",
  ...
  "DATA": [
    {
      "id": "sektor30",
      "ttl": "Fundusz Sektor 3.0 (#TechForGood)",
      "funder": "FRSI / Polsko-Amerykańska Fundacja Wolności",
      "paths": [
        "cogni",
        "ngo-pes"
      ],
      "region": "ogólnopolski",
      "type": "dotacja + inkubacja",
      "amtMin": null,
      "amtMax": 170000,
      "amtNote": "do 170 tys. zł",
      "own": "0% (brak wymaganego wkładu)",
      "deadline": null,
      "timing": "horyzont (nabór cykliczny, ostatni do 26.10.2025 → ed. 2026/27 ~jesień 2026)",
      "verdict": "GO",
      "crit": [
        7,
        10,
      ...
      "link": "https://sektor3-0.pl/fundusz/",
      "verify": false,
      "checkBy": null
    },
    {
      "id": "pes",
      "ttl": "Pożyczki PES — TISE / OIC Lublin",
      "funder": "TISE · OIC Poland (Lublin)",
      "paths": [
        "ngo-pes",
        "infrastruktura"
      ],
      "region": "lubelskie / PL",
      "type": "pożyczka preferencyjna (umarzalna)",
      "amtMin": null,
      "amtMax": null,
      "amtNote": "zależnie od zdolności",
      "own": "0% (brak wymaganego wkładu)",
      "deadline": null,
      "timing": "nabór ciągły (4–10 tyg. do wypłaty)",
      "verdict": "GO",
      "crit": [
        7,
        9,
      ...
      "link": "https://www.tise.pl/",
      "verify": false,
      "checkBy": null
    },
    {
      "id": "oppmech",
      "ttl": "1,5% podatku PIT (mechanizm OPP)",
      "funder": "mechanizm OPP — kampania własna",
      "paths": [
        "przychod",
        "ngo-pes"
      ],
      "region": "PL",
      "type": "przychód stały (nie grant)",
      "amtMin": null,
      "amtMax": null,
      "amtNote": "zależne od kampanii",
      "own": "0%",
      "deadline": "2027-04-30",
      "timing": "szczyt: rozliczenia PIT (marzec–kwiecień)",
      "verdict": "GO",
      "crit": [
        5,
        10,
    ...
    {
      "id": "googlead",
      "ttl": "Google Ad Grants dla NGO",
      "funder": "Google for Nonprofits (via ngo.pl)",
      "paths": [
        "promocja",
        "cogni"
      ],
      "region": "globalny / PL",
      "type": "grant rzeczowy (kredyt reklamowy)",
      "amtMin": null,
      "amtMax": null,
      "amtNote": "~10 tys. USD/mc w reklamach",
      "own": "0%",
      "deadline": null,
      "timing": "nabór całoroczny",
      "verdict": "GO",
      "crit": [
        5,
        10,
      ...
      "link": "https://fundusze.ngo.pl/aktualne",
      "verify": false,
      "checkBy": null
    },
    {
      ...
      "amtMax": 250000,
      "amtNote": null,
      "own": "niski / 0% finansowego",
      "deadline": null,
      "timing": "otwarcie naboru ~listopad 2026",
      "verdict": "GO",
      "crit": [
        7,
        9,
      ...
      "link": "https://niw.gov.pl/",
      "verify": false,
      "checkBy": null
    },
    {
      "id": "erasmus",
      "ttl": "Erasmus+ KA2 — partnerstwa małej skali",
      "funder": "FRSE (Erasmus+)",
      "paths": [
        "cogni",
        "edukacja"
      ...
      "region": "UE",
      "type": "dotacja ryczałtowa (lump sum)",
      "amtMin": 130000,
      "amtMax": 260000,
      "amtNote": "30 000 / 60 000 EUR",
      "own": "0% (ryczałt)",
      "deadline": null,
      "timing": "nabór ~marzec 2027",
      "verdict": "GO",
      "crit": [
        7,
        10,
      ...
      "link": "https://erasmusplus.org.pl/",
      "verify": false,
      "checkBy": null
    },
    {
      "id": "wfos",
      "ttl": "Edukacja ekologiczna — WFOŚiGW Lublin",
      "funder": "WFOŚiGW w Lublinie",
      "paths": [
        "ekologia",
        "edukacja",
        "infrastruktura"
      ...
      "amtMin": null,
      "amtMax": null,
      "amtNote": "zależnie od edycji",
      "own": "częściowy (możliwy niefinansowy)",
      "deadline": null,
      "timing": "okno ~I–II kwartał 2027",
      "verdict": "GO",
      "crit": [
        6,
        6,
      ...
      "link": "https://www.wfos.lublin.pl/",
      "verify": false,
      "checkBy": null
    },
    {
      "id": "niwmrw",
      "ttl": "Fundusz Inicjatyw Międzynar. Roku Wolontariatu",
      "funder": "NIW-CRSO",
      "paths": [
        "ngo-pes",
        "edukacja"
      ...
      "amtMin": 40000,
      "amtMax": 2100000,
      "amtNote": "pula 2,5 mln",
      "own": "niski (sprawdź regulamin)",
      "deadline": null,
      "timing": "otwarty (zweryfikuj termin na ngo.pl)",
      "verdict": "MAYBE",
      "crit": [
        9,
        8,
    ...
    {
      "id": "orlen",
      "ttl": "Program grantowy „Więcej ciepła”",
      "funder": "Fundacja ORLEN",
      "paths": [
        "edukacja",
        "ngo-pes"
      ],
      "region": "ogólnopolski (zweryfikuj zasięg)",
      "type": "dotacja (CSR)",
      "amtMin": null,
      "amtMax": 500000,
      "amtNote": "do 500 tys. zł",
      "own": "zależnie od regulaminu",
      "deadline": null,
      "timing": "otwarty / wkrótce (zweryfikuj)",
      "verdict": "MAYBE",
      "crit": [
        8,
        7,
    ...
    {
      "id": "felu",
      "ttl": "FELU — infrastruktura / edukacja (7.x)",
      "funder": "Fundusze Europejskie dla Lubelskiego 2021–27",
      "paths": [
        "infrastruktura",
        "edukacja"
      ],
      ...
      "amtMax": 2000000,
      "amtNote": "do ~2 mln zł",
      "own": "znaczny (15–20%+, część niefinansowa)",
      "deadline": null,
      "timing": "horyzont (długi proces)",
      "verdict": "MAYBE",
      "crit": [
        10,
        3,
      ...
      "link": "https://www.funduszeeuropejskie.gov.pl/nabory-wnioskow/",
      "verify": true,
      "checkBy": null
    },
    {
      "id": "techedu",
      "ttl": "Mikrogrant: technologia + edukacja + ekologia",
      "funder": "lead z ngo.pl (do weryfikacji)",
      "paths": [
        "cogni",
        "ekologia",
        "edukacja"
      ...
      "link": "https://fundusze.ngo.pl/aktualne?page=1&cats%5B630%5D=631&cats%5B630%5D=637",
      "verify": true,
      "checkBy": null
    },
    {
      "id": "big175",
      "ttl": "Program prywatny 40 tys.–1,75 mln zł",
      "funder": "lead z ngo.pl (do weryfikacji)",
      "paths": [
        "ngo-pes"
      ],
      "region": "centralny / prywatny",
      "type": "dotacja",
      "amtMin": 40000,
      "amtMax": 1750000,
      "amtNote": null,
    ...
    {
      "id": "seniorzy15",
      "ttl": "Działania dla seniorów i społeczności (zdrowa żywność)",
      "funder": "Federacja UTW (via ngo.pl)",
      "paths": [
        "edukacja"
      ],
      "region": "lubelskie (m.in.)",
      "type": "dotacja",
      "amtMin": 13000,
      "amtMax": 15000,
      "amtNote": null,
      "own": "niski",
      "deadline": "2026-07-06",
      "timing": "otwarty — termin 6 lipca 2026",
      "verdict": "SKIP",
      "crit": [
        3,
        7,
